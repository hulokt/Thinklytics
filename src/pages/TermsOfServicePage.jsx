      ...
      <div className="homepage-card shadow-sm border-b border-gray-200 dark:border-gray-700">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
          <div className="flex items-center space-x-4">
            ...
            <h1 className="text-3xl font-bold homepage-text-primary">Terms of Service</h1>
          </div>
        </div>
      </div>
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="text-center mb-16">
          ...
          <h2 className="text-4xl md:text-5xl font-bold homepage-text-primary mb-6">
            Terms of
            <span className="homepage-gradient-text"> Service</span>
          </h2>
        ...
        <div className="bg-red-50 dark:bg-red-900/20 rounded-2xl p-8 mt-12 border border-red-200 dark:border-red-800">
          <h3 className="text-2xl font-bold homepage-text-primary mb-6">Prohibited Activities</h3>
          <p className="homepage-text-secondary mb-6">
          ...
          <div className="grid md:grid-cols-2 gap-4">
            {prohibitedActivities.map((activity, index) => (
              <div key={index} className="flex items-start space-x-3">
                ...
                <span className="homepage-text-secondary">{activity}</span>
              </div>
            ))}
          </div>
        </div>
        ...
        <div className="homepage-card rounded-2xl shadow-xl p-8 mt-12 homepage-hover-glow">
          <h3 className="text-2xl font-bold homepage-text-primary mb-6">Termination</h3>
          <div className="space-y-6">
            <div>
              <h4 className="text-lg font-semibold homepage-text-primary mb-3">Account Termination</h4>
            ...
            <div>
              <h4 className="text-lg font-semibold homepage-text-primary mb-3">Effect of Termination</h4>
              <p className="homepage-text-secondary">
        ...
        {/* Governing Law */}
        <div className="homepage-card rounded-2xl shadow-xl p-8 mt-12 homepage-hover-glow">
          <h3 className="text-2xl font-bold homepage-text-primary mb-6">Governing Law</h3>
          <div className="space-y-6">
            <div>
              <h4 className="text-lg font-semibold homepage-text-primary mb-3">Jurisdiction</h4>
              <p className="homepage-text-secondary">
                These terms shall be governed by and construed in accordance with the laws of the State of Florida, without regard to its conflict of law provisions.
              </p>
            </div>
            <div>
              <h4 className="text-lg font-semibold homepage-text-primary mb-3">Dispute Resolution</h4>
              <p className="homepage-text-secondary">
